...
all_objects_global = [{'diary':{'item':'diary','type':'final','question':"Text on the diary reads \n\"Until I am measured I am not known, yet how you miss me when I have flown. The Number you seek is the letters I contain in my word?",'answer':"4",'clue':"Clock measures it. Enter the number of letters in what clock measures.",'completed':False},
               ...
               {
                   'mannequin':{'item':'mannequin', 'required_prop':None,'type':'final','question':"I have turned her into a mannequin, so be careful!!! A t-shirt on her says, \n“I am present, but also past. I am wrapped, but not a gift. I am named after a parent, but have no children, who am I?<script> (function() { var imageUrl = 'https://drive.google.com/uc?id=1kZnRadBhXozTL9X1n7CP7ZEHSWSvJSwd'; imageUrl = 'url(' + imageUrl.replace(/[\\']/g, '\\$&') + ')'; document.body.style.backgroundImage = imageUrl; })(); </script>”",'answer':"mummy",'clue':"My birth place is Egypt.",'completed':False},
                   'cabinet':{'type':'collection','item':'cabinet','required_prop':'torch', 'pretext':"The doors of the cabinet opens with squeaky sound. \n It is too dark inside, pickup a prop to light things up in cabinet <script> (function() { var imageUrl = 'https://drive.google.com/uc?id=1k6nH6FJCdPVYSkQUbLe7D_BRS-ImOChv'; imageUrl = 'url(' + imageUrl.replace(/[\\']/g, '\\$&') + ')'; document.body.style.backgroundImage = imageUrl; })(); </script>", "action": "With the light you can see a cloth drenched in blood present inside cupboard. Pickup the CLOTH first.",
